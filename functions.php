...
function muszerautomatika_theme_scripts() {
    ...
    wp_enqueue_script('font-awesome', get_template_directory_uri() . '/css/fontawesome/css/fontawesome.min.css', array(), null);
    wp_enqueue_script('font-awesome-brands', get_template_directory_uri() . '/css/fontawesome/css/brands.min.css', array(), null);
