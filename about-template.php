            ...
            <section class="services-section">
                <div class="wrap-narrow">
                    <div class="service-subsection" id="dev">
                        ...
                        <div class="services">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/icon-development.svg" alt="<?php _e('ceruza és vonalzó ikon', 'muszerautomatika-theme'); ?>"><h2><?php _e('Fejlesztés', 'muszerautomatika-theme'); ?></h2>
                        </div>
                    ...
                    <div class="service-subsection" id="manu">
                        ...
                        <div class="services">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/icon-manufacturing.svg" alt="<?php _e('fogaskerék ikon', 'muszerautomatika-theme'); ?>"><h2><?php _e('Gyártás', 'muszerautomatika-theme'); ?></h2>
                        </div>
                    ...
                    <div class="service-subsection" id="service">
                        ...
                        <div class="services">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/icon-service.svg" alt="<?php _e('csavarkulcs ikon', 'muszerautomatika-theme'); ?>"><h2><?php _e('Szakszerviz szolgáltatás', 'muszerautomatika-theme'); ?></h2>
                        </div>
